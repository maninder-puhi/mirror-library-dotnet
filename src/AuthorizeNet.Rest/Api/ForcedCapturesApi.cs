...
namespace AuthorizeNet.Rest.Api
{
    ...
    /// </summary>
    public interface IForcedCapturesApi : IApiAccessor
    {
        ...
        ApiResponse<Payment> CreateAForcedCaptureWithHttpInfo (ForcedCaptureRequest body, string authorization = null);
        ...
        System.Threading.Tasks.Task<Payment> CreateAForcedCaptureAsync (ForcedCaptureRequest body, string authorization = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Payment>> CreateAForcedCaptureAsyncWithHttpInfo (ForcedCaptureRequest body, string authorization = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ForcedCapturesApi : IForcedCapturesApi
    {
        private AuthorizeNet.Rest.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ForcedCapturesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ForcedCapturesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ForcedCapturesApi(Configuration configuration = null)
        {
        ...
        /// <param name="authorization">The value to provide in the Authorization header of ANET API request (optional)</param>
        /// <returns>ApiResponse of Payment</returns>
        public ApiResponse< Payment > CreateAForcedCaptureWithHttpInfo (ForcedCaptureRequest body, string authorization = null)
        {
