...
namespace AuthorizeNet.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateInvoice :  IEquatable<UpdateInvoice>
    {
        /// <summary>
        ...
        public UpdateInvoice(string Description = null, Customer Customer = null, string PayerName = null, string PaymentDueDate = null, decimal? SubAmount = null, decimal? DiscountPercent = null, decimal? DiscountAmount = null, decimal? TotalAmount = null, List<LineItem> LineItems = null, Tax Tax = null)
        {
            // to ensure "Customer" is required (not null)
            if (Customer == null)
            {
                throw new InvalidDataException("Customer is a required property for UpdateInvoice and cannot be null");
            }
            else
            {
            ...
            if (PayerName == null)
            {
                throw new InvalidDataException("PayerName is a required property for UpdateInvoice and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PaymentDueDate is a required property for UpdateInvoice and cannot be null");
            }
            else
            {
            ...
            if (TotalAmount == null)
            {
                throw new InvalidDataException("TotalAmount is a required property for UpdateInvoice and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateInvoice);
        }

        /// <summary>
        /// Returns true if UpdateInvoice instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateInvoice other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
