...
namespace AuthorizeNet.Rest.Model
{
    ...
    public partial class AddressCollection :  IEquatable<AddressCollection>
    {
        ...
        /// <summary>
        /// Gets or Sets TotalAddresses
        /// </summary>
        [DataMember(Name="totalAddresses", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddressCollection);
        }
        ...
        public bool Equals(AddressCollection other)
        {
            ...
            return 
                ...
                (
                    this.TotalAddresses == other.TotalAddresses ||
                    this.TotalAddresses != null &&
                    this.TotalAddresses.Equals(other.TotalAddresses)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalAddresses != null)
                    hash = hash * 59 + this.TotalAddresses.GetHashCode();
                return hash;
            }
        }
    }
