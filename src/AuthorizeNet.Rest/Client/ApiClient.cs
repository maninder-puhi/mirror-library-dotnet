...
namespace AuthorizeNet.Rest.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://api.authorize.net/v1).
        /// </summary>
        public ApiClient()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.authorize.net/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.authorize.net/v1")
        {
